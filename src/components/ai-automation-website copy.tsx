...
const AiAutomationWebsite = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const SCRIPT_URL =
        "https://script.google.com/macros/s/AKfycbwa7cYIWM_c12wVhS39PUt84zoLxOTCUozOdSAVeVKVVOeI2jbgXwpzl-CTsc3ZplOQ5Q/exec";
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white rounded-xl shadow-lg p-8">
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-gray-500">CEO, Tech Solutions</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-8">
              ...
              <p className="text-gray-600 mb-6">
                "Incredible! The Make.com integrations they created for us have
            ...
            <div className="bg-white rounded-xl shadow-lg p-8">
              ...
              <p className="text-gray-600 mb-6">
                ...
                hours per day. Our data analysis processes are now fully
      ...
      <footer className="bg-gray-900 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <h3 className="text-xl font-bold mb-4">TechAI</h3>
